...
//    }
    ...
    public ResponseEntity<?> updateMobileNumber(@RequestParam String customerId, @RequestParam String mobileNo) {
        return service.updateMobileNumber(customerId, mobileNo);
    }
    ...
    public ResponseEntity<?> updateFullName(@PathVariable String customerId, @RequestParam String fullName) {
        return service.updateFullName(customerId, fullName);
    }
}
